...
public class AuthControllerIT extends BaseIT {
    ...
    public void testLogin_returnsJwtResponseJSON() throws Exception {
        ...
        mockMvc.perform(post(APIPaths.LOGIN)
                ...
                .andExpect(jsonPath("$.id")
                        .value(userForLogin.getId()))
                .andExpect(jsonPath("$.username")
                        .value(userForLogin.getEmail()))
    ...
    public void testRegister_returnsNewUserJSON() throws Exception {
        ...
        String userForRegisterJson = JsonUtils.createJsonNodeForObject(
                        userForRegister,
                        List.of("name",
                                "email",
                                "password",
        ...
        mockMvc.perform(post(APIPaths.REGISTER)
                ...
                .andExpect(jsonPath("$.name")
                        .value(userForRegister.getName()))
                .andExpect(jsonPath("$.email")
                        .value(userForRegister.getEmail()));

        //Assert
        Optional<User> registeredUser =
                userRepository.findByEmail(userForRegister.getEmail());
